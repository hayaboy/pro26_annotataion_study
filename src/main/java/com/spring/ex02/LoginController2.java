...
public class LoginController2 {
	...
	@RequestMapping(value = {"/loginForm2.do"}, method = RequestMethod.GET)
...
//	ModelAndView login2(@RequestParam(value = "email", required = true) String email  , HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		ModelAndView login2(@RequestParam(value = "email", required = false) String email  , HttpServletRequest request, HttpServletResponse response) throws Exception{
		ModelAndView mav=new ModelAndView();
